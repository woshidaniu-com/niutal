...
<body>
	<s:form  cssClass="form-horizontal sl_all_form sl_all_bg" role="form" name="form" id="ajaxForm"  method="post" action="/xtgl/jgxx_zjBcJgxx.html" theme="simple" onsubmit="return false;">
		...
		<div class="row">
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			      	  <s:textfield id="jgdm" name="jgdm" cssClass="form-control" validate="{required:true,stringMaxLength:10,chrnum:true,unique:['V0103']}"></s:textfield>
			      </div>
			    </div>
			  </div>
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			      		<s:textfield id="jgmc" name="jgmc" cssClass="form-control" validate="{required:true,stringMaxLength:100,unique:['V0103']}"></s:textfield>
			      </div>
			    </div>
			  </div>
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			      		<s:textfield id="jgjc" name="jgjc" cssClass="form-control" validate="{stringMaxLength:50}"></s:textfield>
			      </div>
			    </div>
			  </div>
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			      		<s:textfield id="jgjp" name="jgjp" cssClass="form-control" validate="{stringMaxLength:20}"></s:textfield>
			      </div>
			    </div>
			  </div>
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			      		<!-- ,unique:['V0103','${jgywmc}'] -->
			      		<s:textfield id="jgywmc" name="jgywmc" cssClass="form-control" validate="{stringMaxLength:100}"></s:textfield>
			      </div>
			    </div>
			  </div>
			  <div class="col-md-6 col-sm-6">
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			      	<div class="input-group">
						...
						<s:textfield name="xm" id="xm"  cssClass="form-control" readonly="true"></s:textfield>
			 ...
			 <div class="col-md-6 col-sm-6">
			  ...
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			      		<s:select name="jglb" list="#{'1':'教学院系','2':'科研机构','3':'公共服务','4':'党务部门','5':'行政机构','6':'附属单位','7':'后勤部门','8':'校办产业','9':'其他'}" listKey="key" cssClass="form-control chosen-select"
