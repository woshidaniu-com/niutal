 ...
 * @类功能描述:   
 * @作者： wzngzg [1060]
 * @时间： 2014-12-1 上午09:01:16 
 * @版本： V4.0.0
 * @修改记录:   
 */
@Controller
@Scope("prototype")
public class JzSsoSessionAction extends BaseAction {
	
	// 
	
	private static final long serialVersionUID = 7897321481404230251L;
	...
	public String jzLogin() {
		...
		try {
			//验证登录口是否开放
			if(!"1".equals(MessageUtil.getText("jzsso2014.state"))){
				//单点登录未启动
				vs.set("msg", "单点登录未启动!");
				return ERROR;
			}
