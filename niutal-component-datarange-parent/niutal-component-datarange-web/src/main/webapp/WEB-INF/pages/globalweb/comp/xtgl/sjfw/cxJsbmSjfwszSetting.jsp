...
<s:else>	
	...
	<!-- 开课部门列表 -->
	<div aria-labelledby="view_xtgl_jsbm"  style="display: none;" class="row">
	...
	<script type="text/javascript" src="<%=systemPath%>/js/globalweb/comp/xtgl/sjfw/js_sjfwsz.js?ver=<%=jsVersion%>"></script>
</s:else>
</body>
</html>
