	...
	<head>
		...
		function save(){
			if (zfValidate.validate()){
				 ajaxSubFormWithFun("xydmForm",'<%=systemPath%>/zfxg/bjdm/zjBcBjdm.html',{},function(data){
			...
			jQuery(function(){
				zfValidate.vf.req.addId("bjdm", "bjmc", "bmdm_id", "zydm_id", "njdm_id");
...
<body>
<s:form action="/zfxg/bjdm/zjBcBjdm.html" method="post" theme="simple" id="xydmForm">
	
	 <div class="tab">
	  <table width="100%"  border="0" class=" formlist" cellpadding="0" cellspacing="0">
	    <thead>
	    	<tr>
	        	<th colspan="4"><span>增加班级</span></th>
	        </tr>
	    </thead>
	    <tfoot>
	      <tr>
	    ...
	    <tbody>
	      <tr>
	        <th width="30%"><span class="red">*</span>班级代码</th>
	        <td width="70%">
	        	<s:textfield maxlength="15" name="bjdm" id="bjdm"></s:textfield> 
	        </td>
	      </tr>
	      <tr>
