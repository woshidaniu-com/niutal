...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			var XsxxGridTwo = Class.create(BaseJqGrid,{  
						caption : "学生信息列表",
						pager: "pager", //分页工具栏  
					    url: _path+'/zfxg!plugins/xsxz_cxXsxzSjfw.html?doType=query',  
					    colModel:[
	...
	<body>
		...
		<div class="toolbox">
			<s:form  action="/zfxg!plugins/xsxz_cxXsxzSjfw.html?doType=query" theme="simple">
			<div class="searchtab">
				<table width="100%" border="0" id="searchTab">
					<tbody>
						<tr>
							...
							<th>年级</th>
							<td>
							<input type="text" name="bynf" id="bynf" style="width:145px;"/>
			...
			<div class="tab">
			    ...
			    <tfoot>
			      <tr>
			        <td colspan="4">
			          <div class="btn">
			            <button name="btn_tj" onclick="xzXsxx();iFClose();" type="button">确 定</button>
