		...
		<div class="row" id="autogrid">
			  <div class="col-md-4 col-sm-6">
			    <div class="form-group">
			      <label for="" class="col-sm-4 control-label">机构</label>
			      <div class="col-sm-8">
			   		  <s:textfield id="jgdm_cx" name="jgdm_cx" cssClass="form-control" placeholder="按机构代码或机构名称查询"></s:textfield>
			      </div>
			    </div>
		      </div>
		</div>
...
<script type="text/javascript" src="<%=systemPath %>/js/globalweb/comp/xtgl/jgxxwh/jgxxwh.js?ver=<%=jsVersion%>"></script>
</html>