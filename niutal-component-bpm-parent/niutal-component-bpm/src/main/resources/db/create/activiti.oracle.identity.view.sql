...
create or replace view ACT_ID_USER as
  select zgh as ID_, 1 as REV_, xm as FIRST_, null as LAST_, dzyx as EMAIL_, null as PWD_, null as PICTURE_ID_ from niutal_xtgl_yhb where zgh <> 'admin' and sfqy = '1'
with READ ONLY;
