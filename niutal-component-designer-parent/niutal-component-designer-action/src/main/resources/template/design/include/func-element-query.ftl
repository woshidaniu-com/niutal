...
<form id="queryForm_${parameters.funcModel.func_guid}" class="form-horizontal sl_all_form" action="" method="post"><#rt/>
<#else>
<form id="queryForm_${func_element.element_id}" class="form-horizontal sl_all_form" action="" method="post"><#rt/>
</#if><#rt/>
	<#if parameters.opt_code == 'cx'>
	<div class="row " id="searchbox_${parameters.funcModel.func_guid}">
	<#else>
	<div class="row " id="searchbox_${func_element.element_guid}">
							...
							<#elseif fieldModel.field_shape == '2'><#rt/>
								...
								<#elseif fieldModel.field_type == '1' || fieldModel.field_type == '4'>
									...
									<#if fieldModel.field_type == '1'>
										<input data-text="${fieldModel.field_text}" type="text" 
		...
		<#else>
		<div class="col-md-12 col-sm-12" style="line-height: 30px;">&nbsp;</div>
		</#if>
	</div>
</form>
<!-- 查询按钮  start.  -->
