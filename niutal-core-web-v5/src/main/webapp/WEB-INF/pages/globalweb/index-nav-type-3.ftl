...
<html lang="zh_CN">
	<head>
		...
		[#include "/globalweb/head/niutal-ui-index-nav-type-3.ftl" /]
		<style>
			/**针对上下文菜单的样式调整**/
			...
			<header id="navbar">
				<div id="navbar-container" class="boxed">
					...
					<div class="navbar-content clearfix">
						...
						<!-- TODO --start -->
						<ul id="top-nav" class="nav pull-left top-nav clearfix">
						</ul>
						<!-- TODO --end -->
				...
				<!-- 面板 -->
				<div class="last_panel" id="last_panel">
				</div>
			</header>

			<div class="boxed" id="boxed" style="height: 914px;">
				<!--中间内容-->
				<div id="content-container" class="content-container" style="padding-left: 0;">

					<div class="zf-content">
						<div class="page-content">
							<div id="tab-general">
								<div id="tabs">
									<div class="nav-container tabs-below" id="tabs281330">
