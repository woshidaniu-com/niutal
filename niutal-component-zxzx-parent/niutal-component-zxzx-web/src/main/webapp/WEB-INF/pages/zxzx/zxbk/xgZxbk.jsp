...
<script type="text/javascript">
	function save() {
		...
		if (inputResult() && checkInputNotNull('bkmc')) {
			ajaxSubFormWithFun('myForm', _path+'/zxzx/kzdk_xgBckzdk.html',{},function(data){
...
<s:form action="kzdk_xgBckzdk" id="myForm" method="post" namespace="/zxzx" theme="simple">
	<s:hidden name="bkdm" />
	<body>
		<div class="tab">
			<table width="100%" border="0" class=" formlist" cellpadding="0"
				...
				<thead>
					<tr>
						<th colspan="4"><span>修改咨询板块</span></th>
					</tr>
				</thead>
				<tfoot>
					<tr>
