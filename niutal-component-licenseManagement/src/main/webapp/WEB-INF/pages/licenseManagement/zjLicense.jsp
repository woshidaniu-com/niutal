...
<html>
	<head>
		...
		function save(){
			if(jQuery.trim($("input[name=authUserCode]").val()) == ''){
				alertMessage('请输入机构代码！');
				return false;
			}
			if(jQuery.trim($("input[name=authUser]").val()) == ''){
				alertMessage('请输入机构名称！');
				return false;
			}
			if(jQuery.trim($("input[name=productName]").val()) == ''){
				alertMessage('请输入业务系统名称！');
				return false;
			}
			...
			ajaxSubFormWithFun("myForm","<%=systemPath%>/license-management/authdata_zjBcLicense.html",{},function(data){
	...
	<body>
	<s:form id="myForm" namespace="/license-management" action="authdata_zjBcLicense" theme="simple">
	 <div class="tab">
	  <table width="100%"  border="0" class="formlist" cellpadding="0" cellspacing="0">
	    ...
	    <tbody>
	      <tr>
	         ...
	         <th width="20%">授权时间</th>
	         <td>
	         	<s:hidden name="authDate"></s:hidden>
	      ...
	      <tr>
	         ...
	         <td>
				<s:textfield name="authUserCode" id="authUserCode" cssStyle="width:76%" theme="simple"></s:textfield> 
	         </td>
	          <th width="20%"><span class="red">*</span>机构名称</th>
	         <td>
				<s:textfield name="authUser" id="authUser" cssStyle="width:76%" theme="simple"></s:textfield> 
	         </td>
	      </tr>
	      <tr>
	      	 <th width="20%"><span class="red">*</span>业务系统</th>
	         <td colspan="3">
	         	<s:textfield name="productName" id="productName" cssStyle="width:76%" theme="simple"></s:textfield> 
	         </td>
	      </tr>
	      <tr>
	      ...
	      <tr>
	         ...
	         <td>
	         	...
	         	<s:hidden name="usageCount" value="0"></s:hidden>
	         </td>
	      </tr>
	      <tr>
	      ...
	      <tr>
	          ...
	          <td colspan="3">
				<s:radio list="#{'1':'是','0':'否'}" name="devMode" id="devMode" value="0" theme="simple"></s:radio>
	         </td>
	      </tr>
	      <tr>
	      	<th width="20%">备注信息</th>
