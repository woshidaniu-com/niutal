...
<body>
<s:form cssClass="form-horizontal sl_all_form" role="form" id="ajaxForm" method="post" action="/design/designFunc_zjzdyanFuncSubPageData.html" theme="simple">
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8">
					...
					<p class="form-control-static"><s:property value="func_name"/> - <s:property value="btn_text"/></p>
				</div>
			</div>
		</div>
		<div class="col-md-12 col-sm-12">
				...
				<div class="col-md-8 col-sm-8">
					...
					<s:iterator value="funtTypeList" status="stat">
						<label class="radio-inline">
						    <input validate="{required:true}" type="radio" id="func_type_<s:property value="#stat.index"/>" name="func_type" <s:if test="key == 2 "> checked="checked"</s:if> value="<s:property value="key"/>" /><s:property value="value"/>
					  	</label>
					</s:iterator>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8">
					...
					<s:iterator value="preCheckList" status="stat">
						<label class="radio-inline">
						    <input validate="{required:true}"  type="radio" id="require_type_<s:property value="#stat.index"/>" name="require_type" <s:if test="key == 1 "> checked="checked"</s:if> value="<s:property value="key"/>" /><s:property value="value"/>
					  	</label>
					</s:iterator>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8">
					<div class="input-group input-group-sm">
						<input type="text" class="form-control" data-toggle="float" id="func_width" name="func_width" placeholder="作为按钮绑定的自定义功能时，弹窗宽度值；单位px" validate="{required:true,stringMaxLength:10,number:true,min:0}" value="800"/>
		...
		<div class="col-md-12 col-sm-12">
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8">
					<input type="text" class="form-control" id="func_name" name="func_name" placeholder="自定义功能名称；将作为弹窗的标题" validate="{required:true,stringMaxLength:50}" value=""/>
				</div>
			</div>
		</div>
		<div class="col-md-12 col-sm-12">
		...
		<div class="col-md-12 col-sm-12">
			<div class="form-group">
				<label for="" class="col-md-3 col-sm-3 control-label">
					<span class="red" id="query_type" style="display: none;">*</span>筛选条件类型
				</label>
				<div class="col-md-7 col-sm-7">
					<s:iterator value="queryTypeList" status="stat">
						<label class="radio-inline">
						    <input validate="{required:true}" class="disabled" disabled="disabled" type="radio" id="query_type_<s:property value="#stat.index"/>" name="query_type" <s:if test="key == 0 "> checked="checked"</s:if> value="<s:property value="key"/>" /><s:property value="value"/>
					  	</label>
					</s:iterator>
				</div>
			</div>
