		...
		<div class="row">
			<div class="col-md-6 col-sm-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<s:select cssClass="form-control chosen-select" id="gnmkdm" name="gnmkdm" list="gnmkList"
			...
			<div class="col-md-6 col-sm-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<s:textfield cssClass="form-control" id="gnmkmc" name="gnmkmc"
							placeholder="功能模块名称模糊查询" maxlength="20"></s:textfield>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="<%=systemPath%>/js/globalweb/comp/xtgl/gnsjkz/timeSetting.js?ver=<%=jsVersion%>"></script>
</html>