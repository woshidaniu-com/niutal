...
public class DBFWriter {
	...
	public DBFWriter(File file, JDBField[] ajdbfield) throws JDBFException {
		stream = null;
		recCount = 0;
		fields = null;
		dbfEncoding = null;
		this.file = file;
		try {
			init(new FileOutputStream(this.file), ajdbfield);
		} catch (FileNotFoundException filenotfoundexception) {
			throw new JDBFException(filenotfoundexception);
		}
	}

	public DBFWriter(File file, List<JDBField> jdbFieldList) throws JDBFException {
		stream = null;
		recCount = 0;
		fields = null;
		dbfEncoding = null;
	...
	public DBFWriter(File file, JDBField ajdbfield[], String s1) throws JDBFException {
		stream = null;
		recCount = 0;
		fields = null;
		dbfEncoding = null;
