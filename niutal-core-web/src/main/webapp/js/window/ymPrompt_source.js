...
(function() {
    ...
    (function() {
        ...
        var winVisible = function(visible) {
            ...
            var ifmStyle = 'position:absolute;width:100%;height:100%;top:0;left:0;opacity:1;';
            ym_body.innerHTML = !curCfg.iframe ? ('<div class="' + curCfg.msgCls + '">' + curCfg.message + '</div>') : "<iframe style='" + ifmStyle + "' border='0' frameborder='0' src='" + curCfg.message + "'></iframe><div style='" + ifmStyle + ";background:#000;opacity:0.1;display:none'></div>"; //内容
            (function(el, obj) {
