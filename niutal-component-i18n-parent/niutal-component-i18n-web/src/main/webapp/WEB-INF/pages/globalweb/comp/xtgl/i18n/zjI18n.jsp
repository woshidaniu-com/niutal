...
<body>
	<s:form cssClass="form-horizontal sl_all_form sl_all_bg" role="form"
		...
		action="/i18n/i18n_zjBcI18n.html" theme="simple"
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<s:textfield id="res_key" name="res_key" cssClass="form-control"
							validate="{required:true,stringMaxLength:50,nowhitespace:true,unique:['V0200','违反唯一性约束，已存在相同的资源']}"></s:textfield>
					</div>
				</div>
			</div>
			<div class="col-md-12 col-sm-12">
