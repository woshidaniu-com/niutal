...
<body>
	<s:form  cssClass="form-horizontal sl_all_form sl_all_bg" role="form" name="form" id="ajaxForm"  method="post" action="/xtgl/xqxx_zjBcXqxx.html" theme="simple" onsubmit="return false;">
		<s:hidden name="xqh_id"></s:hidden>
		<div class="row">
