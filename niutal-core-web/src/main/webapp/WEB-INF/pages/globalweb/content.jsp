		...
		//modify by wgx 修改jqgrid 缩放和展开时没缩放和展开的BUG
			function changeWin() {
				...
				if (left.attr("class") != "hide") {
					...
					var rightWidth = jQuery(".formbox").css("width");
			...
			function showhidediv(o,id){
				...
				jQuery(".textlink .close ~ul").css("display","none");
				jQuery(".textlink .close").attr("class","open");
				
				jQuery(o).attr("class","close");
				jQuery(".textlink .close ~ul").css("display","");
			}	
