...
<script type="text/javascript">
	jQuery(function() {
		...
		jQuery("#searchZxkzdtn").click(function() {
			var searchValue = jQuery.trim(jQuery("#zxzxSearch").val());
			jQuery("#webSearchValue").val(searchValue);
			jQuery("#form_index").submit();
			return false;
		});
				...
				<div class="panel-body" id="inside">
					...
					<div id="myTabContent" class="tab-content ">
						<div role="tabpanel" class="tab-pane fade active in" id="tab01"
							...
							<div class="panel-body" style="border-bottom: 1px solid #ddd;margin-top:15px;padding:15px"">
							  ...
							  <div class="col-sm-6">
							    <div class="input-group input-group-sm" style="width:250px">
									<input type="text" class="form-control" id="zxzxSearch" value="<s:property value="webSearchValue" />">
							      	<span class="input-group-btn">
							        	<button id="searchZxkzdtn" class="btn btn-default" type="button">搜索</button>
							      	</span>
							    </div>
							  </div>
							</div>
							...
							<s:form namespace="/zxzx/web" action="index" id="form_index" method="post" theme="simple">
							...
							<div class="panel-body">
								<s:if test='webSearchBkdmValue == null or webSearchBkdmValue==""'>
									<span datatype="search-bkdm" datavalue="" class="label label-primary" style="cursor: pointer;">全部</span>
								</s:if>
								<s:else>
									<span  datatype="search-bkdm" datavalue="" class="label label-info" style="cursor: pointer;">全部</span>
								</s:else>
								<s:iterator value="kzdkList" id="kzdk" status="iterator">
									<span datatype="search-bkdm" datavalue="${kzdk.bkdm}" class="label <s:property value='#kzdk.bkdm==webSearchBkdmValue ? "label-primary":"label-info"' />" style="cursor: pointer;">${kzdk.bkmc}</span>
								</s:iterator>
							</div>
							...
							<div class="panel-body">
								...
								<jsp:include page="/WEB-INF/pages/zxzx/web_v_2/pageFootMenu.jsp?formid=form_index" ></jsp:include>
							</div>
							</s:form>
						</div>
						</div>
