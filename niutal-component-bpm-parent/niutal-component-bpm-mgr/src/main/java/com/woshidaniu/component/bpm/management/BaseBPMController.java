...
public abstract class BaseBPMController {
	...
	protected static enum BPMMessageKey {
		...
		FORM_MODEL_ADD_SUCCESS("F99041","success"), 
		FORM_MODEL_ADD_FAIL("F99042","fail"),
		
		FORM_MODEL_UPDATE_SUCCESS("F99061","success"), 
		FORM_MODEL_UPDATE_FAIL("F99062","fail"),
		
		FORM_MODEL_DEL_SUCCESS("F99051","success"), 
		FORM_MODEL_DEL_FAIL("F99052","fail"),
		
		FORM_MODEL_COPY_SUCCESS("F99071","success"), 
		FORM_MODEL_COPY_FAIL("F99072","fail"),
		
		FORM_MODEL_DEPLOY_SUCCESS("F99081","success"), 
		FORM_MODEL_DEPLOY_FAIL("F99082","fail"),
		
		FORM_DEFINITION_ACTIVE_SUCCESS("F99011", "success"), 
		FORM_DEFINITION_ACTIVE_FAIL("F99012", "fail"), 
		FORM_DEFINITION_SUSPEND_SUCCESS("F99021","success"), 
		FORM_DEFINITION_SUSPEND_FAIL("F99022","fail"), 
		FORM_DEFINITION_DEL_SUCCESS("F99031","success"), 
		FORM_DEFINITION_DEL_FAIL("F99032","fail"),
		FORM_DEFINITION_NOT_FOUND("F99001", "fail");
