...
<div class="page">
	...
	<nav>
	  <ul id="pagediv" class="pagination pagination-sm">
	    <li>
	    ...
	    <li class="disabled">
	    	<a id="page_pre" href="#">${queryModel.currentPage}/${queryModel.totalPage}页(共：${queryModel.totalResult}条记录)</a>
	    </li>
...
<script type="text/javascript">
	...
	function submitPageForm(){
		...
		jQuery("#<%=request.getParameter("formid")%>").submit();
	}
