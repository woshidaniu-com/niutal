...
<s:hidden id="kzdx" name="kzdx" value="xs"></s:hidden>
<div class="row">
	...
	<div class="col-md-4 col-sm-4">
	  	<div class="form-group">
	    	...
	    	<div class="col-sm-8">
			   	<s:select list="jgdmsList" listKey="jg_id" listValue="jgmc" headerKey="" multiple="false" headerValue="全部" cssClass="form-control width-80 chosen-select" id="jgdm_query"></s:select>
	    	</div>
	    	<SCRIPT type="text/javascript">
	...
	<div class="col-md-4 col-sm-4">
	   <div class="form-group">
	     	...
	     	<div class="col-sm-8">
	     		<input value=""  class="form-control width-80" id="yhm_query" data-toggle="autocomplete" data-autocomplete-type="xs" data-set-value="value" data-real-value="key"  data-format="value（key）"  placeholder="输入用户名或姓名">
	    	</div>
	  	</div>
	</div>
  </div>
