...
<!--tab标签-->
<link rel="stylesheet" type="text/css" href="${messageUtil("system.stylePath")}/assets/plugins/tabs/css/tabs.css?ver=${messageUtil("niutal.jsVersion")}" />
<script type="text/javascript" src="${base}/js/globalweb/comp/index/jquery.tabs.js?ver=${messageUtil("niutal.jsVersion")}" charset="utf-8"></script>
...
<!--基础交互js-->
<script type="text/javascript" src="${base}/js/globalweb/comp/index/niutal-ui-index-nav-type-3.js?ver=${messageUtil("niutal.jsVersion")}"></script>
