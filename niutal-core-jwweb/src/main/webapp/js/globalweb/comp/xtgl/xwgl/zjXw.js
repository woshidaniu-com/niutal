jQuery(function($) {
	...
	var editor = KindEditor.create('#fbnr', $.extend(true,{},newsOption,{
		afterCreate: function () {
			...
			//清除内存
			$("#fbnr").on("kineditor:sync", function(){
				editor.html(""); 
				editor.sync();
			});
	...
	$("#selectID").click(function () {
		var mxdxlb  = $("#mxdxlb").val();
		 switch(mxdxlb){
		    case '1'://学生
		    	$.showDialog(_path+'/xtgl/xwgl_cxMxStudentIndex.html','选择面向对象', mxdxConfig);
		    break;
		    case '2'://教师
		    	$.showDialog(_path+'/xtgl/xwgl_cxMxteacherIndex.html','选择面向对象', mxdxConfig2);
		    break;
		    case '3'://岗位
		    	$.showDialog(_path+'/xtgl/xwgl_cxMxGwIndex.html','选择面向对象', mxdxConfig3);
		    break;
		 }
	});
});