...
/**
 * 
 *@类名称		： EmailClientSettingController.java
 *@类描述		：
 *@创建人		：kangzhidong
 *@创建时间	：2017年5月10日 上午10:06:10
 *@修改人		：
 *@修改时间	：
 *@版本号	:v1.0
 */
...
public class EmailClientSettingController extends BaseController{
	
	@Resource
	private CsszPropsProvider csszPropsProvider;
	
	@RequiresPermissions("ms-mailclient:cx")
	@RequestMapping(value="settings")
	public String sms_settings(HttpServletRequest request){
		return "/ms/email_settings";
	}
	 ...
	 *@修改描述	:
	 */
	@BusinessLog(czmk = "系统管理", czms = "修改邮件客户端参数", ywmc = "消息服务", czlx = BusinessType.UPDATE)
	@ResponseBody
	@RequiresPermissions("ms-mailclient:xg")
