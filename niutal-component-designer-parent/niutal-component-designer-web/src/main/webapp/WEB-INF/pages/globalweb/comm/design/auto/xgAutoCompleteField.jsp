...
<body>
<s:form cssClass="form-horizontal sl_all_form" role="form" id="ajaxForm" method="post" action="/design/baseAuto_xgAutoCompleteFieldData.html" theme="simple">
	<s:hidden id="auto_guid" name="auto_guid" />
	<div class="row">
		...
		<div class="col-md-12 col-sm-12">
			<div class="form-group">
				...
				<div class="col-md-7 col-sm-7">
					<s:textfield cssClass="form-control" id="field_format"  name="field_format" validate="{required:true,stringMaxLength:50}" placeholder="此值在你需进行特殊的显示时，改变这个值可以改变组件每个元素显示的组合效果，默认是value（key）"></s:textfield>
				</div>
			</div>
		</div>
		<div class="col-md-12 col-sm-12">
