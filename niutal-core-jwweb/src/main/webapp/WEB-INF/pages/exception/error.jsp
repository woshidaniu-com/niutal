...
<div class="error_v5">
	...
	<div class="error_con">
		<p class="error_title"><s:text name="error.msg"/></p>
		<p class="error_text0 hidden"><s:text name="error.tips"/></p>
		<p class="error_text"></p>
		<p class="error_link"><a href="<%=systemPath%>/xtgl/index_initMenu.html?t=<%=new Date().getTime()%>" class="go_index"><i></i><s:text name="error.gohome"/></a></p>
	</div>
</div>
<script type="text/javascript" src="<%=systemPath%>/js/globalweb/comp/xtgl/exception-error.js?ver=<%=jsVersion%>"></script>
</body>
</html>