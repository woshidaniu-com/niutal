	    ...
	    <tbody>
	    	<tr>
				...
				<td colspan="2" valign="center">
					<span id="bmspan">
						<s:select list="bmList" name="bm" id="bm" listKey="jg_id" listValue="jgmc" headerKey="" headerValue="" theme="simple" ></s:select>
					</span>					
                   ...
                   <button type="button" onclick="queryUser();return false;" class="btn btn-primary">
						查询
				   </button>
	            </td>
			</tr>
