...
<body>
<form id="ajaxForm" action="<%=systemPath%>/xtgl/jsgl_zjBcJsxx.html" method="post" data-toggle="validation" theme="simple"  role="form" class="form-horizontal sl_all_form">
	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12">
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-8">
					<s:textfield name="jsmc" id="jsmc" cssClass="form-control  input-sm span3" validate="{required:true,stringMinLength:2,stringMaxLength:50,unique:['V0101']}"></s:textfield>
				</div>
			</div>
		</div>
		<div class="col-md-12 col-sm-12">
