...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function save(){
				if (zfValidate.validate()){
					 ajaxSubFormWithFun("xydmForm",'<%=systemPath%>/zfxg/zydm/xgBcZydm.html',{},function(data){
		...
		jQuery(function(){
				zfValidate.vf.req.addId("zymc","bmdm_id_lsbm","xz");
			});
			
		</script>

<s:form action="/zfxg/zydm/xgBcXydm.html" method="post" theme="simple" id="xydmForm">
	<body >
     <input type="hidden" name="doType" value="save"/>   
     <input type="hidden" id="zydm" name="zydm" value="${model.zydm}"/>  
	 <div class="tab">
	  <table width="100%"  border="0" class=" formlist" cellpadding="0" cellspacing="0">
	    <thead>
	    	<tr>
	        	<th colspan="4"><span>修改专业</span></th>
	        </tr>
	    </thead>
	    <tfoot>
	      <tr>
	    ...
	    <tbody>
	      ...
	      <tr>
	         <th width="30%"><span class="red">*</span>所属学院</th>
	        <td width="70%">
