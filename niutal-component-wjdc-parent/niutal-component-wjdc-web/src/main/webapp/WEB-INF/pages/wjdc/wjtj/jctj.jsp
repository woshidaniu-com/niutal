...
<html xmlns="http://www.w3.org/1999/xhtml">
			...
			function searchResult() {
				...
				if(stidy==""){
					...
					if(jQuery("#rightContent").length > 0){
						ajaxSubForm("form_djtj", "<%=systemPath %>/zfxg/wjdc/wjtj_jctj.html");
					}else{
						subForm("<%=systemPath %>/zfxg/wjdc/wjtj_jctj.html");
					}				
	...
	<s:form namespace="/zfxg/wjdc" action="wjtj_jctj" method="post" id="form_djtj" theme="simple">
