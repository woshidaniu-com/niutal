	...
	jQuery(function(){
		...
		jQuery("a[datatype='zxzx-kzdt']").click(function(){
			...
			if(!clickData[dataValue]){
				jQuery.post(_path+"/zxzx/web/updateDjl.html",{"zxid":dataValue,"bkdm":bkdm},function(){
		...
		<div class="mainframe mainframe_tm">
			...
			<div class="left_qz02 left_myzq clear-after">
				<div class="top_title01">
					<ul class="xxk_01">
						<li class="cur"><a href="<%=systemPath%>/zxzx/web/index.html">讨论区</a></li>
					...
					<div class="search_qz" style="margin-top: 15px;">
						<form id="zxzxSearchFormId" method="post">
							<input id="zxzxSearch" name="zxzxSearch" type="text" value="<s:property value="webSearchValue" />"/>
							<button id="searchZxkzdtn">搜索</button>
						</form>
					</div>
				</div>
						...
						<div class="recommend_xxq">
							<ul>
								...
								<li>
									...
									<div class="text">
										<h4>
											<a href="###" datatype="zxzx-kzdt" datavalue="${zxwt.zxid}" databkdm="${zxwt.bkdm}" class="title">${zxwt.kzdt}</a>
										</h4>
										<p>
											   
											咨询人：
											<a href="###"><s:property value="#zxwt.zxr != null ? #zxwt.zxrModel.xm.substring(0,1)+'**' : '匿名'" /></a>
											
											<span> | </span>版块：<span>${zxwt.kzdkModel.bkmc} | </span>咨询时间：<span>${zxwt.zxsj} | </span>点击量：<span>${zxwt.djl}</span>
										</p>
									</div>
