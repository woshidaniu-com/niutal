...
function checkIdCard(selectValue,varInput) {
   ...
   //获取证件类型
   // var selectValue = $("#psptTypeCode").val();
...
{	//空校验
	//if(varInput=="") 
	//	return CheckInfoErrorMsg.showErrorMsg(CheckInfoErrorMsg.nullMsgError(selectValue),"idCardError","idCardCorrect","idCard");
	var flag = false;
	switch(selectValue){
		//户口本
		...
		//台湾居民来往大陆通行证
		case "11":flag = !CheckInfoUtils.checkByReg(varInput,(varInput.length==8?regUrl.passForMainlandReg8:regUrl.passForMainlandReg11));break;
	...
	//if(flag)
	//	return CheckInfoErrorMsg.showErrorMsg(CheckInfoErrorMsg.inCorrectFormError(selectValue),"idCardError","idCardCorrect","idCard");
