...
ResourceManager = {
    ...
    __createResource: function(e) {
        ...
        if ((d.length == 1) && (d[0].object.isResource())) {
            ...
            ResourceManager.__request("POST", b, a,
            function() {
    ...
    __Resource: function(b, a) {
        ...
        this.reload = function() {
            var d = this.__url;
            var c = this.__id;
            ResourceManager.__request("GET", d, null,
            function() {
        ...
        this.save = function(e) {
            ...
            ResourceManager.__request("PUT", d, data,
            function() {
        ...
        this.remove = function() {
            var d = this.__url;
            var c = this.__id;
            ResourceManager.__request("DELETE", d, null,
            function() {
    ...
    request: function(c, a) {
        ...
        return ResourceManager.__request(b.method, c, b.data, (b.onSuccess instanceof Function ?
        function() {
            b.onSuccess(this)
        }: undefined), (b.onFailure instanceof Function ?
        function() {
            b.onFailure(this)
...
ORYX.CONFIG.CANVAS_WIDTH = 1980;
ORYX.CONFIG.CANVAS_HEIGHT = 5050;
                    ...
                    if (ORYX.Editor.checkClassType(this.element, SVGLineElement)) {
                        ...
                        if (ORYX.Editor.checkClassType(this.element, SVGPolylineElement) || ORYX.Editor.checkClassType(this.element, SVGPolygonElement)) {
                            ...
                            if (this.element.points && this.element.points.numberOfItems) {
                                for (var z = 0,
                                s = this.element.points.numberOfItems; z < s; z++) {
...
ORYX.Core.SVG.Label = Clazz.extend({
    ...
    _positionText: function() {
        ...
        delete this._isUpdating; (this.changeCallbacks || []).each(function(e) {
            e.apply(e)
        })
    },
...
ORYX.Core.Math.getInverseMatrix = function(b) {
    var c = ORYX.Core.Math.getDeterminant(b),
    a = b;
    return {
        a: c * ((a.d * 1) - (a.f * 0)),
        b: c * ((a.f * 0) - (a.b * 1)),
...
ORYX.Core.StencilSet.Rules = {
    ...
    getLayoutingRules: function(b, d) {
        ...
        var a = function(f, e) {
            if (f && f[e]) { ["t", "r", "b", "l"].each(function(g) {
                    c[e][g] = Math.max(f[e][g], c[e][g] || 0)
                })
            }
            if (f && f[e + "s"] instanceof Array) { ["t", "r", "b", "l"].each(function(k) {
        ...
        }.bind(this)); ["in", "out"].each(function(e) { ["t", "r", "b", "l"].each(function(f) {
...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
    construct: function(c, b, a) {
        ...
        if (ORYX.CONFIG.BACKEND_SWITCH) {
            ...
            new Ajax.Request(ACTIVITI.CONFIG.contextRoot + "/editor/stencilset.zf?version=" + Date.now(), {
                asynchronous: false,
                method: "get",
...
ORYX.Core.AbstractShape = ORYX.Core.UIObject.extend({
    ...
    getAbstractShapesAtPosition: function() {
        ...
        if (this.isPointIncluded(b, e)) {
            ...
            var c = this.getChildEdges(); [d, c].each(function(f) {
                var g = new Hash();
                f.each(function(h) {
                    if (!h.isVisible) {
                        return
    ...
    toJSON: function() {
        var a = {
            ...
            this.properties, this.hiddenProperties).inject({},
            function(d, h) {
                var c = h[0];
                var f = h[1];
...
ORYX.Editor.provideId = function() {
    ...
    b[8] = b[13] = b[18] = b[23] = "-";
    return "oryx_" + b.join("") + "_" + new Date().getTime();
};
...
function() {
    ...
    ORYX.Core.MoveDockersCommand = ORYX.Core.Command.extend({
        ...
        updateEdge: function(a) {
            a._update(true); [a.getOutgoingShapes(), a.getIncomingShapes()].flatten().invoke("_update", [true])
        },
        ...
        if (this._dockerUpdated || this.isChanged || c) {
            ...
            this.getLabels().each(function(C) {
                if (C.getReferencePoint()) {
                    ...
                    var K = w.segment.from,
                    b = w.segment.to;
                    if (!K || !K.parent || !b || !b.parent) {
                        return
                    }
                    var J = K.bounds.center(),
                    B = b.bounds.center();
    ...
    handleChildShapesAfterAddDocker: function(f) {
        ...
        this.getLabels().each(function(m) {
            ...
            if (l >= o.segment.fromIndex && l <= o.segment.toIndex) {
                ...
                var k = n.fromDocker.bounds.center(),
                p = n.toDocker.bounds.center();
...
ORYX.Plugins.AbstractPlugin = Clazz.extend({
    ...
    getRDFFromDOM: function() {
        try {
            ...
            ORYX.Log.error("error serializing "+g);
            return ""
        }
    },
            ...
            execute: function() {
                if (this.changes) {
                    ...
                    this.edges.each(function(e) {
                        this.changes.push({
                            edge: e,
                            oldDockerPositions: e.dockers.map(function(f) {
...
ORYX.Plugins.CanvasResizeButton = Clazz.extend({
    construct: function(b, t, g) {
        ...
        false);
        c.addEventListener(ORYX.CONFIG.EVENT_MOUSEOVER,
        function(u) {
            n()
        },
        true);
        h.addEventListener(ORYX.CONFIG.EVENT_MOUSEOVER,
        function(u) {
            n()
        },
        true);
...
ORYX.Plugins.ProcessLink = Clazz.extend({
    ...
    show: function(a, b) {
        var c = ORYX.Editor.graft("http://www.w3.org/2000/svg", null, ["a", {
            target: "_blank"
        },
        ["path", {
            "stroke-width": 1,
        ...
        var a = ORYX.Core.Command.extend({
            construct: function(g, f, e) {
                ...
                this.elAndIndex = f.map(function(h) {
                    return {
                        el: h,
                        previous: h.parent.children[h.parent.children.indexOf(h) - 1]
                    }
                });
                this.facade = e
            },
...
ORYX.Core.Command.Move = ORYX.Core.Command.extend({
    ...
    move: function(d, a) {
        for (var g = 0; g < this.moveShapes.length; g++) {
            ...
            l.bounds.moveBy(d);
            if (l instanceof ORYX.Core.Node) { (l.dockers || []).each(function(k) {
                    k.bounds.moveBy(d)
                });
    ...
    dockerMovedFinished: function(e) {
        ...
        if (this.outerDockerNotMoved) {
            ...
            var c = ORYX.Core.Command.extend({
                ...
                rollback: function() {
                    this.dock(this.oldDockedShape, this.oldPosition); (this.removedDockers || $H({})).each(function(g) {
    ...
    ORYX.Plugins.BPMN2_0 = {
        ...
        updateDepth: function(c, b, d) {
            ...
            c.getChildNodes().each(function(f) {
                f.bounds.moveBy(e, 0); [].concat(children[j].getIncomingShapes()).concat(children[j].getOutgoingShapes())
            })
        },
        ...
        adjustWidth: function(b, c) { (b || []).each(function(d) {
