...
public class CollectionUtilTest {
	...
	public void testSplitList(){
		...
		List<List<?>> rList = CollectionUtil.splitList(list, 3);
	...
	public void testRemoveDupValue(){
		...
		List<Integer> rList = CollectionUtil.removeDupValue(list1);
		...
		List<String> rList2 = CollectionUtil.removeDupValue(list2);
		...
		List<Object> rList3 = CollectionUtil.removeDupValue(list3);
