...
<s:else>	
	...
	<!-- 开课部门列表 -->
	<div aria-labelledby="view_xtgl_cdbm"  style="display: none;" class="row">
	...
	<script type="text/javascript" src="<%=systemPath%>/js/globalweb/comp/xtgl/sjfw/cd_sjfwsz.js?ver=<%=jsVersion%>"></script>
</s:else>
</body>
</html>
