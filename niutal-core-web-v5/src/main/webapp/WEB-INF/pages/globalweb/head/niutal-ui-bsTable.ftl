...
<script type="text/javascript" src="${messageUtil("system.stylePath")}/assets/plugins/bootstrap-table/extensions/multiple-sort/bootstrap-table-multiple-sort.min.js?ver=${messageUtil("niutal.jsVersion")}" charset="utf-8"></script>
<script type="text/javascript" src="${messageUtil("system.stylePath")}/assets/plugins/bootstrap-table/extensions/multiple-sort/bootstrap-table-multiple-sort-zh-CN.min.js?ver=${messageUtil("niutal.jsVersion")}" charset="utf-8"></script>
