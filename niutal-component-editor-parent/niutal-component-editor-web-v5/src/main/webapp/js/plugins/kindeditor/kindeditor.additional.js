 ...
 */
//编辑器路径
var editorPath = _path+"/js/plugins/kindeditor",
	//样式文件路径
	//处理文件上传的访问路径
	...
	//word文档上传路径
	var wordUploadUrl = _path+'/filemgr/kineditorWordUpload/upload.zf';
...
var defaultOption = {
	...
	themesPath: _path + "/js/plugins/kindeditor/themes/",
	pluginsPath:_path + "/js/plugins/kindeditor/plugins/",
	...
	items : [
		...
		'plainpaste', 'wordupload', '|', 'justifyleft', 'justifycenter', 'justifyright',
