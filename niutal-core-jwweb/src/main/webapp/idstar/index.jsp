...
<%
	String is_config = request.getRealPath("/WEB-INF/properties/client.properties");
	...
	if (decodedCookieValue != null ) {
    	...
    	request.getSession().setAttribute("userName",curUser);
    	response.sendRedirect("../api/icelogin_ssoLogin.html");
    }
