...
<script type="text/javascript">
	function save() {
		...
		ajaxSubFormWithFun('myForm', _path+'/zxzx/kzdk_qytyBckzdk.html',{},function(data){
...
<s:form action="kzdk_qytyBckzdk" id="myForm" method="post" namespace="/zxzx" theme="simple">
	<s:hidden name="bkdm" />
	<body>
		<div class="tab">
			<table width="100%" border="0" class=" formlist" cellpadding="0"
				...
				<thead>
					<tr>
						<th colspan="4"><span>启用/停用 咨询板块</span></th>
					</tr>
				</thead>
				<tfoot>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td width="70%">
							<s:radio list="#{'1':'开启','0':'关闭'}" name="sfqy" id="sfqy" theme="simple"></s:radio>
						</td>
					</tr>
				</tbody>
			</table>
