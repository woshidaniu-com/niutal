...
[#include "/layouts/zxzx-web-head_v5-no-deps.ftl" /]
<!--在线咨询个性化样式-->
<link rel="stylesheet" type="text/css"
	href="${base}/css/zxzx/web/zxzx-web.css?ver=${messageUtil(" niutal.cssVersion")}" />
<!--在线咨询个性化脚本-->
<script src="${base}/js/zxzx/zxzx-web.js" type="text/javascript"
	charset="utf-8"></script>
<!-- 模板引擎 -->
<script src="${base}/js/zxzx/template-render.js" type="text/javascript"
	charset="utf-8"></script>
		...
		<div class="search-area clearfix">
			<div class="search">
				<i class="glyphicon glyphicon-search"></i> <input type="text"
					placeholder="请输入查找的内容" id="zxzx-web-search-box" /> <i
					id="zxzx-web-search-box-remove" class="glyphicon glyphicon-remove"></i>
			</div>
		</div>

		<div class="content clearfix">
			<div class="left-area hidden-xs">
				<div class="item active" id="topic" data-url="${base}/zxzx/web/page/topic.zf"
					data-content="topic-content">
					全部问题
					<!-- 					全部问题<span class="number count">(77)</span> -->
				</div>
				<div class="item" id="faq" data-url="${base}/zxzx/web/page/faq.zf"
				...
				[#if sfxswdwt == '1']
				<div class="item" id="my-topic" data-url="${base}/zxzx/web/page/auth/my-topic.zf"
					data-content="my-topic-content">
					我的提问
...
<!-- 	<div class="footer"> -->
<!-- 		<div class="container"> -->
<!-- 			<p>版权所有© Copyright 1999-2017 我是大牛软件 浙ICP -->
<!-- 				中国·</p> -->
<!-- 		</div> -->
<!-- 	</div> -->
</body>
