...
<body>
	<s:form  cssClass="form-horizontal sl_all_form sl_all_bg" role="form" name="form" id="ajaxForm"  method="post" action="/xtgl/zyxx_xgBcZyxx.html" theme="simple" onsubmit="return false;">
		<s:hidden name="zyh_id"></s:hidden>
		<div class="row">
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      <label for="" class="col-sm-4 control-label"><span style="color:red;">*</span>专业代码</label>
			      <div class="col-sm-8">
			      	  <s:textfield id="zyh" name="zyh" cssClass="form-control" validate="{required:true,stringMaxLength:10,chrnum:true,unique:['V1507','${zyh}','违反唯一性约束，已存在相同的专业代码或大类代码']}"></s:textfield>
			      </div>
			    </div>
			  </div>
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			      		<s:textfield id="zymc" name="zymc" cssClass="form-control" validate="{required:true,stringMaxLength:60,unique:['V1507','${zymc}','违反唯一性约束，已存在相同的专业代码或大类代码']}"></s:textfield>
			      </div>
			    </div>
			  </div>
			  <div class="col-md-6 col-sm-6">
...
<%--			  </div>			 --%>
			  <div class="col-md-6 col-sm-6">
			    <div class="form-group">
			      <label for="" class="col-sm-4 control-label">学制</label>
			      <div class="col-sm-8">
			      		<s:textfield id="xz" name="xz" cssClass="form-control" validate="{stringMaxLength:2,chrnum:true}"></s:textfield>
			      </div>
			    </div>
			  </div>
			  <div class="col-md-6 col-sm-6">
