...
<body>
<form id="ajaxForm" action="jsgl_zjBcJsxx.html" method="post" data-toggle="validation" theme="simple"  role="form" class="form-horizontal sl_all_form">
		...
		<s:if test="parent!=null">
			<div class="col-md-12 col-sm-12">
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-8">
						<input type="hidden" name="jsjb" value="<s:property value="parent.jsjb"/>" />
