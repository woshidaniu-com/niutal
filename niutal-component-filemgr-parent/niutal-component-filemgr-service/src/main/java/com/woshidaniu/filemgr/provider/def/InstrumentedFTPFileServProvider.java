 ...
 */
public class InstrumentedFTPFileServProvider extends FTPFileServProvider {
	...
	public void afterPropertiesSet() throws Exception {
		...
		this.getTimer = metricsFactory.getTimer(name(this.getClass(), "filemgr", "ftp", "gets"));
        this.putTimer = metricsFactory.getTimer(name(this.getClass(), "filemgr", "ftp", "puts"));
        this.delTimer = metricsFactory.getTimer(name(this.getClass(), "filemgr", "ftp", "puts"));
	}
