	...
	<div class="row" id="autogrid">
		<div class="col-md-4 col-sm-6">
	    	<div class="form-group">
		        ...
		        <div class="col-sm-8">
		   		  <s:select id="cx_jg_id" name="cx_jg_id" list="jgList" listKey="jg_id" listValue="jgmc"  headerKey="" headerValue="全部" 
		   		  cssClass="form-control chosen-select"/>
		        </div>
      			<SCRIPT type="text/javascript">
		    	  	jQuery('#cx_jg_id').trigger("chosen");
		    	</SCRIPT>	
	    	</div>
	   </div>
	   <div class="col-md-4 col-sm-6">
	    	<div class="form-group">
		      	...
		      	<div class="col-sm-8">
		   		  <s:textfield id="cx_zyh" name="cx_zyh" cssClass="form-control" placeholder="按专业号、专业名称模糊查询"></s:textfield>
		      	</div>
	    	</div>
       </div>
       <div class="col-md-4 col-sm-6">
	    	<div class="form-group">
	      		<label for="" class="col-sm-4 control-label">使用状态</label>
		        <div class="col-sm-8">
		   		  <s:select id="cx_sfty" name="cx_sfty" list="#{'':'全部','0':'启用','1':'停用'}" value="0" cssClass="form-control chosen-select"/>
		        </div>
      			<SCRIPT type="text/javascript">
		    	  	jQuery('#cx_sfty').trigger("chosen");
		    	</SCRIPT>	
	    	</div>
	   </div>
	</div>
...
<script type="text/javascript" src="<%=systemPath %>/js/globalweb/comp/xtgl/zyxxwh/zyxx.js?ver=<%=jsVersion%>"></script>
</html>