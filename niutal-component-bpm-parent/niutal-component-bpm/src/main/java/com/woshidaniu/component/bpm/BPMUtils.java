...
public final class BPMUtils extends StringUtils {
	...
	public static void assertNotNull(String notNullValue){
		if (notNullValue == null || notNullValue.trim().length() == 0) {
			throw new BPMException("BPM_EX_01", "");
		}
	}
	
	public static void assertProcessDefinationKeyNotNULL(String processDefinationKey) {
	...
	public static void assertTaskIdNotNULL(String taskId) {
		if (taskId == null || taskId.trim().length() == 0) {
			throw new BPMException("BPM_EX_03", "TaskId can not be NULL");
		}
	}

	public static void assertTaskDefKeyNotNULL(String taskDefKey) {
