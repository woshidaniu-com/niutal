...
public class InstrumentedBrowserFileFTPProvider extends BrowserFileFTPProvider implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		this.getTimer = metricsFactory.getTimer(name(this.getClass(), "browser", "ftp", "gets"));
	}
