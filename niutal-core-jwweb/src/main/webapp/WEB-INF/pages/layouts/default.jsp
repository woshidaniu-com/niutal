...
<head>
	...
	<!--jQuery核心框架库 -->
	<script type="text/javascript" src="<%=stylePath%>/js/jquery-1.11.3.min.js?ver=<%=jsVersion%>"></script>
	<script type="text/javascript" src="<%=stylePath%>/js/jquery-migrate-1.4.1.min.js?ver=<%=jsVersion%>"></script>
	<!--jQuery浏览器检测 -->
