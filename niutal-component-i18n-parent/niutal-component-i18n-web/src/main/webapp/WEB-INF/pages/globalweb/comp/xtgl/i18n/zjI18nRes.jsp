...
<body>
	<s:form cssClass="form-horizontal sl_all_form sl_all_bg" role="form"
		...
		action="/i18n/i18n_zjBcI18nRes.html" theme="simple"
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<s:textfield id="res_code" name="res_code" cssClass="form-control"
							validate="{required:true,stringMaxLength:50,nowhitespace:true,multiUnique:['V0201',['#res_code', '#res_type'],'违反唯一性约束，已存在相同的资源文件配置!']}"
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<s:select list="#{'js':'javasript', 'properties': 'properties' }"
							...
							validate="{required:true,multiUnique:['V0201',['#res_code', '#res_type'],'违反唯一性约束，已存在相同的资源文件配置!']}"></s:select>
...
<script type="text/javascript" src="<%=systemPath%>/js/globalweb/comp/xtgl/i18n/zjI18nRes.js?ver=<%=jsVersion%>"></script>
</html>