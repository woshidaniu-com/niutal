...
var KisBpmFormPropertiesPopupCtrl = ['$scope', '$q', '$translate', '$timeout', function($scope, $q, $translate, $timeout) {
	...
	//example: "formproperties":{"formProperties":[{"id":"p_decision","name":"审核","type":"enum","readable":true,"writable":true,"enumValues":[{"id":"PASS","name":"通过"},{"id":"NOPASS","name":"不通过"}],"required":true}]}
