...
import com.woshidaniu.taglibs.views.components.SelectComponent;

@SuppressWarnings("serial")
public class SelectTag extends AbstractDatasetTag {
	...
	public Component getBean(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
		return new SelectComponent(stack, request, response);
	}
