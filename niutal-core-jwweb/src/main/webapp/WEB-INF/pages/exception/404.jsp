...
<div class="error_v5">
	...
	<div class="error_con">
		...
		<p class="error_text0 hidden"><s:text name="error.msg404"/></p>
		<p class="error_text"></p>
		<p class="error_link"><a href="#" class="go_index"><i></i><s:text name="error.gohome"/></a><a href="#"  class="go_back"><i></i><s:text name="error.goback"/></a></p>
	</div>
</div>
